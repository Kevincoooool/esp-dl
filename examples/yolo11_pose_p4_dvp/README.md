...
The example supports both DVP and MIPI CSI camera sensors. You can configure the camera type in menuconfig:

**Example Configuration:**
- `CONFIG_EXAMPLE_ENABLE_DVP_CAM_SENSOR` - Enable DVP camera sensor
- `CONFIG_EXAMPLE_ENABLE_MIPI_CSI_CAM_SENSOR` - Enable MIPI CSI camera sensor

**Priority:** If both sensors are enabled, DVP sensor will be used by default.

**DVP Configuration:**
- I2C port, SCL/SDA pins for SCCB communication
- Camera reset and power down pins
- DVP data pins (D0-D7), VSYNC, DE, PCLK, XCLK pins
- XCLK frequency
