...
#define LCD_TYPE_ST7701 1
//  #define   LCD_TYPE_ST7703 1
//  #define   LCD_TYPE_GC9503 1
...
#elif defined LCD_TYPE_ST7701
#include "esp_lcd_st7701.h"
#define PANEL_BUS_DSI_2CH_CONFIG ST7701_PANEL_BUS_DSI_2CH_CONFIG
#define PANEL_IO_DBI_CONFIG ST7701_PANEL_IO_DBI_CONFIG
#define PANEL_DPI_CONFIG ST7701_480_800_PANEL_60HZ_DPI_CONFIG
#define KSDIY_MIPI_DSI_LCD_H_RES 480
#define KSDIY_MIPI_DSI_LCD_V_RES 800
#endif
...
#define KSDIY_PIN_NUM_BK_LIGHT 45
...
static void ksdiy_bsp_init_lcd_backlight(void)
{
    ...
    gpio_config_t bk_gpio_config = {.mode = GPIO_MODE_OUTPUT, .pin_bit_mask = 1ULL << KSDIY_PIN_NUM_BK_LIGHT};
...
void ksdiy_lvgl_port_init(void)
{
    ...
    // 配置显示设备
    const lvgl_port_display_cfg_t disp_cfg = {.io_handle = mipi_dbi_io,
                                              .panel_handle = panel_handle,
                                              .buffer_size =
                                                  KSDIY_MIPI_DSI_LCD_H_RES * KSDIY_MIPI_DSI_LCD_V_RES, // 缓冲区大小
